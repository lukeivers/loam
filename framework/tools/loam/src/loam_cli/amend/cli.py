...
``pos_amend.*`` to ``loam`` / ``loam_cli.amend.*``; the public
...
from loam_cli.amend.commands import seal as seal_cmd
from loam_cli.amend.commands import template as template_cmd
from loam_cli.amend.commands import validate as validate_cmd
