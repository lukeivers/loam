...
Universal admissions: `docs/rebuild/plans/`, `CLAUDE.md`, `docs/rebuild/STATE.md`, `docs/rebuild/FUTURE_IDEAS.md`, `docs/rebuild/FUTURE_IDEAS_DRAFT.md`, `docs/odd-in-loam.md`, `docs/odd-methodology.md`.
