...
`docs/rebuild/plans/amendment-40-primary-persona-tracker-context-contributor.manifest.yaml` — per plan §10 stub. BASELINE = HEAD~1 of the amendment commit (i.e., the immediate-prior commit) per #34–#39 pattern. Captured at amendment-commit time.
