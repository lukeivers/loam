...
- **loam-rename decisions (Idea 10 authority):**
  `docs/plans/loam-rename-decisions.md` — Tier-1 + Tier-2
...
- **OSS-launch research (positioning, repo hygiene, launch sequencing):**
  `docs/plans/research/loam-open-source-launch-research.md`.
- **FUTURE_IDEAS authority:**
  - Idea 10 (rename to loam): `docs/FUTURE_IDEAS.md:430` —
    UN-TABLED 2026-04-29.
  - Idea 12 (OSS launch): `docs/FUTURE_IDEAS.md:510` —
    ACTIVE 2026-04-29; three open rulings closed.
  - Idea 3 (Dev/SDLC plugin): `docs/FUTURE_IDEAS.md:278` —
    must-ship at v1 per Idea 12.
- **STATE.md:** governing rules + component table; row added 2026-04-29
  for OSS publish.
- **Spec:** `docs/spec/pos-v2-objectives-spec.md` — the
  contract being built against. AC.PO.1 + AC.PO.2 in
  `docs/VALUE_PROPOSITION.md` are the prime objective ACs;
...
the established `docs/plans/` convention.
...
`docs/plans/oss-launch-decisions.md`.
...
`docs/plans/oss-v0-1-0-publish-<slug>.md` for sub-plans
...
|----|----------|-------------|-----|---------|----------|
| **M0** | (this plan) | Owner approves v0.1.0 plan + sub-plan ladder. Authority captured in `docs/plans/oss-launch-decisions.md`. | — | (owner time only) | — |
...
- **Idea 10 — rename to loam:** `docs/FUTURE_IDEAS.md:430`.
  Authority: `docs/plans/loam-rename-decisions.md`.
  Mechanics: `.scratch/claude-output/loam-rename-migration-plan.md`.
- **Idea 12 — open-source launch of loam:**
  `docs/FUTURE_IDEAS.md:510`. Authority: this plan +
  `docs/plans/oss-launch-decisions.md` (M0 output).
  Research: `docs/plans/research/loam-open-source-launch-research.md`.
- **Idea 3 — initial plugin suite (Dev/SDLC plugin scope):**
  `docs/FUTURE_IDEAS.md:278`. Source for M6.
...
`docs/VALUE_PROPOSITION.md` as the prime spec hooks. Per
