...
- Master plan: `docs/rebuild/plans/odd-rebuild-master-plan-2026-05-05.md` §3 v0.2.5.
...
- **AC.V025-C4P.7 — AC.OBJX.5 + synthesis-method-decision documented.** **outcome-altitude: false** (audit-trail AC).
  ...
  - Verification: `grep "C4-pivot" docs/rebuild/plans/v0-2-5-corrective-c4-pivot-claude-print-synthesis.md` returns the §14 entries.
...
6. **STATE update commit.** Inline pivot entry in `docs/rebuild/STATE.md` mirroring C3's shape; mention pivot magnitude explicitly.
