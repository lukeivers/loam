...
- AC-6: `docs/rebuild/FUTURE_IDEAS.md` gains a new Core Development
...
- `docs/rebuild/FUTURE_IDEAS.md` — new Core Development Convention inserted before "setup scripts self-retire on success."
