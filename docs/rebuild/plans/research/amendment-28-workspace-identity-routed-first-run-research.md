...
**Governs plan:** `docs/rebuild/plans/amendment-28-workspace-identity-routed-first-run.md`.
...
> — `docs/rebuild/components/true-first-run/proposal.md:§8.3` (Eve's
...
> — `docs/rebuild/components/namespaced-labels-and-bootout/proposal.md:§3`
...
`docs/rebuild/FUTURE_IDEAS.md` Idea 9 (workspace-slug collision
