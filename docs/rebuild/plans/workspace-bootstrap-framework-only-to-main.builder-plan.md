...
Companion to `docs/rebuild/plans/workspace-bootstrap-framework-only-to-main.md`.
...
- `docs/rebuild/plans/workspace-bootstrap-framework-only-to-main.manifest.yaml`
...
- `docs/rebuild/STATE.md` — new Change log entry dated 2026-05-04
