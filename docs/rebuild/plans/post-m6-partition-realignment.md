...
**Programme master:** `docs/rebuild/plans/oss-v0-1-0-publish.md` (this sub-plan closes the LAST PRE-PUBLISH BLOCKER per dispatcher recommendation analysis 2026-04-29; M11 dry-run is unblocked once this seals).
**Predecessors sealed:**
...
**Authority documents:**
- M9 plan-doc HSF#1 (partition completeness gap): `docs/rebuild/plans/oss-v0-1-0-publish-scrub.md` §7 finding #1.
- M1c-corrective plan-doc HSF#1 (broader dev-mode-manifest staleness): `docs/rebuild/plans/oss-v0-1-0-publish-rename-1c-corrective.md` §16 HSF#1.
- FUTURE_IDEAS_DRAFT.md item: `docs/rebuild/FUTURE_IDEAS_DRAFT.md` (dev-mode-manifest broader staleness; M1c-corrective build agent capture 2026-04-29).
...
- Master plan: `docs/rebuild/plans/oss-v0-1-0-publish.md`.
...
`framework/hands-off-lifecycle/hooks/corpus_inline_session_start.py` `_ON_DEMAND` tuple's first two entries are `plugins/dev-sdlc/docs/odd-methodology.md` and `plugins/dev-sdlc/docs/odd-in-loam.md`. The third entry (`docs/rebuild/FUTURE_IDEAS.md`) is unchanged.
...
- **Adding new corpus sources** (e.g. promoting `docs/rebuild/STATE.md` from always-load to on-demand) — out of scope; this amendment preserves the existing 3-always + 3-on-demand split.
...
- `framework/memory-system/launchd/README.md` → `docs/rebuild/components/true-first-run/research.md` (1).
- `framework/primary-persona/templates/persona-template/prompt.md` → `docs/rebuild/FUTURE_IDEAS_DRAFT.md` (1).
- `framework/workspace-sync/README.md` → `docs/rebuild/plans/workspace-sync.{md,builder-plan.md,manifest.yaml}` (3).
...
- Master plan: `docs/rebuild/plans/oss-v0-1-0-publish.md`.
- M9 plan-doc: `docs/rebuild/plans/oss-v0-1-0-publish-scrub.md` §7 finding #1.
- M1c-corrective plan-doc: `docs/rebuild/plans/oss-v0-1-0-publish-rename-1c-corrective.md` §16 HSF#1.
- FUTURE_IDEAS_DRAFT.md: `docs/rebuild/FUTURE_IDEAS_DRAFT.md` (M1c-corrective build agent capture 2026-04-29).
- M2 partition manifest: `framework/tools/pos-publish-framework-only/publish-mode-manifest.yaml`.
- corpus_gate hook source: `framework/hands-off-lifecycle/hooks/corpus_inline_session_start.py` + `corpus_load_session_start.py` + `corpus_load_sentinel.py`.
- dev-mode-manifest: `plugins/dev-sdlc/dev-mode-manifest.yaml`.
...
- Sealed-component invariants CDC: `plugins/dev-sdlc/docs/conventions/sealed-component-invariants.md`.
- Commit-ladder CDC: `plugins/dev-sdlc/docs/conventions/commit-ladder.md`.
- VALUE_PROPOSITION (prime objective): `docs/rebuild/VALUE_PROPOSITION.md`.
