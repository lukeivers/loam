...
- Programme research: `docs/rebuild/plans/research/structural-enforcement-of-critical-requirements-research.md` (locked 2026-04-26).
- A1 plan: `docs/rebuild/plans/structural-enforcement-a1-substrate.md` (sealed; amendment #51).
- A2 plan: `docs/rebuild/plans/structural-enforcement-a2-objective-binding-gate.md` (sealed; amendment #70).
- A2 builder plan: `docs/rebuild/plans/structural-enforcement-a2-objective-binding-gate.builder-plan.md` (records D-build choices).
...
**Pre-flight staleness result:** A3 has not shipped. `git log --grep="A3\|tdd-guard"` returns only A2's commit (which mentions A3 as the next gate). `ls docs/rebuild/plans/ | grep -iE "a3|tdd-guard"` is empty.
...
- Locked research (governs): `docs/rebuild/plans/research/structural-enforcement-of-critical-requirements-research.md`
- A1 plan (sealed): `docs/rebuild/plans/structural-enforcement-a1-substrate.md`
- A2 plan (sealed): `docs/rebuild/plans/structural-enforcement-a2-objective-binding-gate.md`
- A2 builder plan (records D-build choices A3 inherits / questions): `docs/rebuild/plans/structural-enforcement-a2-objective-binding-gate.builder-plan.md`
...
- VALUE_PROPOSITION: `docs/rebuild/VALUE_PROPOSITION.md` (AC.PO.1 + AC.PO.2 — Lens 2 anchor)
- FUTURE_IDEAS: `docs/rebuild/FUTURE_IDEAS.md` Idea 1 (programme), Idea 8 (structural context-load gate)
- FIDRAFT items: `docs/rebuild/FUTURE_IDEAS_DRAFT.md` lines 130 (corpus-inlining), 136 (main-session-write-prevention), 143 (dispatch-staleness)
...
*End of research artefact. Plan-doc at `docs/rebuild/plans/structural-enforcement-a3-tdd-guard.md` consumes these findings.*
