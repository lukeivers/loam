...
plan `docs/rebuild/plans/d-migration.md`). D.1 moves all framework
...
**Manifest:** `docs/rebuild/plans/d-migration-1.manifest.yaml`
...
14. Author manifest at `docs/rebuild/plans/d-migration-1.manifest.yaml`.
...
18. `pos-amend seal --plan-doc /Users/lukeivers/ivers-corp-pos-v2/docs/rebuild/plans/d-migration.md --plan d-migration-1.manifest.yaml`.
...
The `docs/rebuild/components/<comp>/` admissions DO NOT change
(docs/ stays at root).
...
- `universal_paths.prefixes`: `["docs/rebuild/plans/"]` (docs stays
  at root).
...
- `docs/rebuild/plans/d-migration.md` (parent plan)
- `docs/rebuild/plans/amendment-46-persona-session-start-turn-start-emitters.manifest.yaml`
