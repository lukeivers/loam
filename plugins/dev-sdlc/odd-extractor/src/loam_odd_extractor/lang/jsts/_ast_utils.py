...
Per RF gap §10 #6 — ``slugify`` + ``file_slug`` are byte-identical to
Ruby's; refactor into ``lang/_common/`` deferred to Cycle 4b/5.
"""
...
def slugify(text: str) -> str:
    ...
    DRY surface (RF §10 #6): identical to ``lang/ruby/_ast_utils.slugify``.
    """
