...
- `docs/plans/memory-system-live-client-and-stop-hook-write.builder-plan.md`
  (this file, new).
- `docs/plans/memory-system-live-client-and-stop-hook-write.manifest.yaml`
...
`/Users/lukeivers/ivers-corp-pos-v2/docs/plans/research/memory-system-live-client-and-stop-hook-write-research.md`
...
## 5. Manifest (`docs/plans/memory-system-live-client-and-stop-hook-write.manifest.yaml`)
