...
**Programme master:** `docs/rebuild/plans/oss-v0-1-0-publish.md` (master plan §5 M2 row + §6 sequencing rule #2).
...
- Programme AC: AC.OSS.3 (no dev-discipline machinery in public synthesis output) — `docs/rebuild/plans/oss-v0-1-0-publish.md` §3.
...
sub-plan-doc + manifest YAML under `docs/rebuild/plans/`.
...
- `framework/tools/pos-publish-framework-only/...` (the entire
  subtree).
- `docs/rebuild/plans/oss-v0-1-0-publish-partition.md` (this
  plan-doc).
- `docs/rebuild/plans/oss-v0-1-0-publish-partition.manifest.yaml`
...
3. **Plan + manifest commit.** Commit this plan-doc + a manifest
   YAML at `docs/rebuild/plans/oss-v0-1-0-publish-partition.manifest.yaml`
...
14. **Phase K — Seal-diff fence verification.** AC.OSS-M2.S +
    ...
    + `docs/rebuild/plans/oss-v0-1-0-publish-partition.{md,manifest.yaml}`.
...
- **AC.OSS-M2.3 (synth.py consumes manifest):** verified by
  ...
  docs/rebuild/STATE.md + docs/positioning.md; assert post-
...
- **Series predecessor:** `docs/rebuild/plans/oss-v0-1-0-publish-rename.md`
...
- **Precedent single-component sealed-amendment manifests:**
  - `docs/rebuild/plans/oss-v0-1-0-publish-rename-1c.manifest.yaml` (M1c launchd labels — comparable single-narrative-anchor shape).
  - `docs/rebuild/plans/oss-v0-1-0-publish-rename-1g.manifest.yaml` (M1g — for the universal-admissions block precedent).
