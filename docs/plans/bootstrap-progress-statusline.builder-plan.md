...
**Plan governs:** `docs/plans/bootstrap-progress-statusline.md` (D1–D6 LOCKED 2026-04-26).
...
16. `docs/plans/bootstrap-progress-statusline.md` — already on disk; gets committed as part of amendment.
17. `docs/plans/bootstrap-progress-statusline.builder-plan.md` — this file; committed.
18. `docs/plans/bootstrap-progress-statusline.manifest.yaml` (NEW) — see §3.
...
plan: docs/plans/bootstrap-progress-statusline.md
...
11. `pos-amend seal --plan-doc docs/plans/bootstrap-progress-statusline.md` — sidecar bumps + narrative + plan-doc SHA section.
...
```
pos-amend seal docs/plans/bootstrap-progress-statusline.manifest.yaml --plan-doc docs/plans/bootstrap-progress-statusline.md
```
