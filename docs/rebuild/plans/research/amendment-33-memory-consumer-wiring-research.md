...
`docs/rebuild/plans/research/memory-consumer-wiring-research-plan.md`.
...
- Research plan: `docs/rebuild/plans/research/memory-consumer-wiring-research-plan.md`
- Sibling D8 research plan: `docs/rebuild/plans/research/session-start-context-load-gate-research-plan.md`
- Memory-system proposal: `docs/rebuild/components/memory-system/proposal.md`
...
- Amendment #24 research: `docs/rebuild/plans/research/amendment-24-memory-system-mcp-migration-research.md`
- Primary-persona proposal: `docs/rebuild/components/primary-persona-loader/proposal.md`
- Primary-persona D3 monitor: `primary-persona/src/monitor.py`
- Scope-of-work proposal: `docs/rebuild/components/scope-of-work/proposal.md`
- Session-resilient-orchestrator proposal: `docs/rebuild/components/session-resilient-orchestrator/proposal.md`
- Session-start supervisor: `orchestrator/scripts/pos_session_start.py`
- Objective-tracker proposal: `docs/rebuild/components/objective-tracker/proposal.md`
- Self-correction proposal: `docs/rebuild/components/self-correction-loop/proposal.md`
