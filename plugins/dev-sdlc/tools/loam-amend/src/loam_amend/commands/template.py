...
# Path arithmetic: post-M6b.1 this file lives at
#   plugins/dev-sdlc/tools/loam-amend/src/loam_amend/commands/template.py
# parents[0]=commands/, [1]=loam_amend/, [2]=src/, [3]=loam-amend/,
# [4]=tools/, [5]=dev-sdlc/, [6]=plugins/, [7]=<workspace>.
#
# Per M6b.0 (D-build.M6b0.3 / F2 mechanism mirror) + carried through
# M6b.1: dispatch + plan templates live at plugins/dev-sdlc/templates/.
# The resolver probes for plugin-side templates first, falling back
# to the loam-amend package's own templates directory (defensive
# only — post-M6b.1 the package itself ships no bundled templates).
# Mirror of amendment #67's ``_resolve_corpus_path`` probe-and-prefer
# pattern. ``DEFAULT_TEMPLATES_ROOT`` resolves to the plugin-side
