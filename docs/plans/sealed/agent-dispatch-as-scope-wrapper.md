...
**Research (governs):**
`docs/plans/research/harness-usage-audit-2026-04-26.md`
...
plan: docs/plans/agent-dispatch-as-scope-wrapper.md
...
- Sealed-component proposals A8 composes on:
  - `docs/archive/component-research/scope-of-work/proposal.md`
  - `docs/archive/component-research/orchestrator/proposal.md`
  - `docs/archive/component-research/cost-governance/proposal.md`
  - `docs/archive/component-research/safety-layer/proposal.md`
  - `docs/archive/component-research/reversibility-primitive/proposal.md`
...
- VALUE_PROPOSITION:
  `docs/VALUE_PROPOSITION.md` (translation-layer §;
  paragraph 4 is the token-discipline anchor for AC.PO.1).
- STATE / FUTURE_IDEAS:
  `docs/STATE.md`, `docs/FUTURE_IDEAS.md`.
- v1.1 R12 spec text:
  `docs/spec/pos-v2-objectives-spec.md` line 300–306.
