...
Companion to `docs/rebuild/plans/amendment-38-objective-tracker-schema-widening.md`.
...
- `docs/rebuild/plans/amendment-38-objective-tracker-schema-widening.manifest.yaml`
