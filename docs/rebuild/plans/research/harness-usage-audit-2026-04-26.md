...
**Reading method:** for each of the 13 sealed components, read `docs/rebuild/components/<name>/proposal.md` heads + `<src>/__init__.py` (public surface) + grep for production callers (excluding tests, `.egg-info`, in-component imports).
