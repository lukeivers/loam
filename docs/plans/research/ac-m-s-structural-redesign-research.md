...
**Captured in:** `docs/FUTURE_IDEAS_DRAFT.md` ("AC.M.S
...
(amendment #48 plan, `docs/plans/memory-system-live-client-
...
`hands-off-lifecycle/seals/`, `docs/plans/`,
`docs/plans/research/`, plus universal-paths files —
...
- `docs/FUTURE_IDEAS_DRAFT.md` ("AC.M.S structural
