...
- Decay-retention analysis: `docs/archive/decay-retention-analysis.md`
- Foundation audit (the source of this BACKLOG's re-grounding): `docs/archive/component-research/foundation-audit/research.md`
