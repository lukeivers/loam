...
- `/tmp/pos3-integration-test-report-20260425T163453Z.md` — the
  ...
  heuristic.
- `docs/archive/component-research/objective-tracker/` (post-#38),
...
`docs/odd-methodology.md`, `docs/odd-in-pos.md`, `docs/STATE.md`,
`docs/FUTURE_IDEAS.md`, dev CDCs, `tools/pos-amend/` surfaces,
or `docs/plans/`. The session-start corpus DOES include
...
presence-or-absence of `docs/VALUE_PROPOSITION.md` for any
...
(`docs/plans/heavy-b-phase-alpha-beta-gamma-migration.md`); see
