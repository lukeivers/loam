...
### `docs/plans/amendment-34-memory-system-eager-lifespan-d1-conformance.manifest.yaml`
...
- Universal-paths block: `docs/plans/` prefix; CLAUDE.md and
  docs/odd-*.md and docs/FUTURE_IDEAS.md files (mirror
