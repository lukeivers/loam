...
**Parent plan:** `docs/rebuild/plans/v0-2-3-master-plan.md` §3 Cycle 2 + §4 Cycle 2 dispatch brief + §6 + §9 method-decision register.
...
**PRIMARY:** `plugins/dev-sdlc/odd-extractor/`. **TERTIARY:** `docs/rebuild/plans/` (plan-doc paper trail).
...
Authority: build the 7 AC.BACKMAP.* + 8 AC.OBJRAT.* families (15 ACs) per sub-plan-doc §3. Single-component fence on plugins/dev-sdlc/odd-extractor/. Tertiary admission: docs/rebuild/plans/.
...
Source pointers (READ FIRST):
  - sub-plan-doc (THIS file) at docs/rebuild/plans/v0-2-3-cycle-2-backing-map-and-ratification-reframe.md
  - master plan §3 Cycle 2 + §4 + §6 + §9 at docs/rebuild/plans/v0-2-3-master-plan.md (commit 35155fd)
  - Cycle 1 sub-plan-doc at docs/rebuild/plans/v0-2-3-cycle-1-multi-source-objective-synthesis.md (sealed 9b9f87c; §14 backfill 66de327)
...
- **Master plan:** `docs/rebuild/plans/v0-2-3-master-plan.md` §3 Cycle 2 + §4 + §6 + §9 (`35155fd`).
- **Cycle 1 sub-plan-doc:** `docs/rebuild/plans/v0-2-3-cycle-1-multi-source-objective-synthesis.md`. Sealed `9b9f87c`; §14 `66de327`; master §9 `914809d`.
...
Cycle-2 method decisions at §7. Master-plan method decisions at master plan §9 (`docs/rebuild/plans/v0-2-3-master-plan.md`). Cycle 1 method decisions at `docs/rebuild/plans/v0-2-3-cycle-1-multi-source-objective-synthesis.md` §7.
