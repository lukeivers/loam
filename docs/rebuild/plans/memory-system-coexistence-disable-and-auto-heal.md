...
`docs/rebuild/plans/research/memory-system-coexistence-triage-research.md`
...
the universal-paths admissions (`docs/rebuild/plans/`,
`CLAUDE.md`, `docs/odd-in-pos.md`, `docs/odd-methodology.md`,
`docs/rebuild/FUTURE_IDEAS.md`). Anything outside this set is a
halt condition.
...
plan: docs/rebuild/plans/memory-system-coexistence-disable-and-auto-heal.md
...
- Umbrella plan (parent of #46/#47/#48 and this amendment):
  `docs/rebuild/plans/memory-into-context-integration.md`
- Amendment #33 (D7) plan + research:
  `docs/rebuild/plans/amendment-33-memory-consumer-wiring-primary-persona.md`,
  `docs/rebuild/plans/research/amendment-33-memory-consumer-wiring-research.md`
...
- Amendment #47 builder plan (sibling pattern for `.mcp.json` + workspace-bootstrap adapter shape):
  `docs/rebuild/plans/amendment-47-workspace-local-mcp-json-writer.builder-plan.md`
