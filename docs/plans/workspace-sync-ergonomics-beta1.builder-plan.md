...
**Companion plan:** `docs/plans/workspace-sync-ergonomics.md` (§1-§5 + AC.β.1).
...
**Choice.** Schema v1 manifest (no objectives block; mirrors #57's manifest pattern). One sealed component touched: workspace-sync. Universal-paths admissions for `docs/plans/` + the four CLAUDE.md / odd-* / FUTURE_IDEAS.md files (mirrors #57). Narrative target: `workspace-sync/seals/SEAL_COMMIT.ergonomics-beta1`.
...
7. **Author manifest** (`docs/plans/workspace-sync-ergonomics-beta1.manifest.yaml`). ~10 min.
...
| `docs/plans/workspace-sync-ergonomics.md` | EXTEND (§14 backfill at seal time) | ~+30 |
| `docs/plans/workspace-sync-ergonomics.vars.yaml` | unchanged (already authored) | 0 |
| `docs/plans/workspace-sync-ergonomics-beta1.builder-plan.md` | NEW (this file) | this file |
| `docs/plans/workspace-sync-ergonomics-beta1.manifest.yaml` | NEW | ~150 lines |
...
- Plan-doc: `docs/plans/workspace-sync-ergonomics.md`
- Plan-vars: `docs/plans/workspace-sync-ergonomics.vars.yaml`
- Manifest (this amendment): `docs/plans/workspace-sync-ergonomics-beta1.manifest.yaml`
- #56 precedent: `docs/plans/workspace-sync.md` + `.builder-plan.md` + `.manifest.yaml`
- #57 precedent: `docs/plans/workspace-sync-resolver-cost-overhaul.md` + `.builder-plan.md` + `.manifest.yaml`
- VALUE_PROPOSITION (binding spec): `docs/VALUE_PROPOSITION.md`
