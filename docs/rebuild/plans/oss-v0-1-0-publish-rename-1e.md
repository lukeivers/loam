...
5. **Item 6 — Filename rebrands per Idea 10's no-retroactive-rewrites convention.** Two specific renames per dispatcher ruling 3:
   ...
   - `docs/rebuild/spec/loam-objectives-spec.md` → `docs/rebuild/spec/loam-objectives-spec.md` (current contract; renames).
...
- `docs/rebuild/spec/loam-objectives-spec.md` and `docs/rebuild/spec/pos-v2-rebuild-proposal.md` referenced by ~5 live files (mostly STATE.md / VALUE_PROPOSITION.md cross-references).
...
All cross-references from live docs / code / fixtures pointing at `docs/odd-in-loam.md` (19 callsites — see §11 finding #2) and at `docs/rebuild/spec/loam-objectives-spec.md` (~5 callsites) update concurrently to point at the renamed paths. Cross-references at `docs/rebuild/spec/pos-v2-rebuild-proposal.md` stay verbatim (preserved filename).

**Outcome:**
- `ls docs/odd-in-loam.md` exists; `ls docs/odd-in-loam.md` does NOT.
- `ls docs/rebuild/spec/loam-objectives-spec.md` exists; `ls docs/rebuild/spec/loam-objectives-spec.md` does NOT.
...
- `docs/rebuild/spec/loam-objectives-spec.md` (RENAMED to `docs/rebuild/spec/loam-objectives-spec.md`).
...
2. **(Spec filename cross-reference inventory — non-blocking; surfaces the per-rename callsite count.)** Pre-build verification of cross-references:
   ...
   - `docs/rebuild/spec/loam-objectives-spec.md` referenced by ~5 live files (STATE.md, VALUE_PROPOSITION.md, cross-cutting plan-docs).
