...
**Successor target:** C2-prime re-plan + dispatch (separate plan-doc at `docs/plans/oss-v0-1-0-publish-public-docs-classes-abc-prime.md`).
...
**M11 plan:** `docs/plans/oss-v0-1-0-publish-dry-run.md` — §5 AC.M11a.2 outcome bound.
...
3. Amendment manifest commit — at `docs/plans/oss-v0-1-0-publish-public-docs-classes-abc-bis.manifest.yaml`.
...
- **C2-prime — Class C 21-file production remediation.** Authored in a separate plan-doc (`docs/plans/oss-v0-1-0-publish-public-docs-classes-abc-prime.md`) and dispatched after this amendment seals.
...
- C1+C2 combined sub-plan: `docs/plans/oss-v0-1-0-publish-public-docs-classes-abc.md`.
