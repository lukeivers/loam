...
- Plan-doc: `docs/rebuild/plans/v0-1-8-cycle-4b-ruby-fixture-and-dry-refactor.md` (this file).
- Manifest: `docs/rebuild/plans/v0-1-8-cycle-4b-ruby-fixture-and-dry-refactor.manifest.yaml` (schema v3 — `plan_doc_ref` + `ac_count` + `smoke_outcome`).
...
- Universal admissions: `docs/rebuild/plans/` + `plugins/dev-sdlc/docs/odd-methodology.md` (mirrors Cycle 4a).
