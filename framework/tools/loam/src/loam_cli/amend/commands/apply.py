...
from loam_cli.amend.baseline import BaselineNotFound, read_baseline, set_baseline
from loam_cli.amend.dry_run import analyse, format_reports
from loam_cli.amend.manifest import ManifestError, load_manifest
from loam_cli.amend.paths import find_repo_root
from loam_cli.amend.rename_detection import is_rename_only
from loam_cli.amend.seal_diff import BindingNotFound, widen_binding
from loam_cli.amend.sidecar import read_sidecar, write_sidecar
from loam_cli.amend.tracker_registration import (
...
def run(manifest_path: Path, *, dry_run: bool) -> int:
    ...
    for comp in manifest.components:
        ...
        # See `loam_cli.amend.rename_detection.is_rename_only` + plan-doc
        # AC.D.1.5.1.
