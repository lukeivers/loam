...
A hook process inherits the parent environment, apart from the OTEL_* exporter variables that Claude Code removes from every subprocess it spawns , including hooks.
