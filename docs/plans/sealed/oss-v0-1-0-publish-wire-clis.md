...
**Programme master:** `docs/plans/oss-v0-1-0-publish.md` (master plan §5 M3 row + §6 sequencing rule #3).
...
- Programme AC: AC.OSS.2 (D-3) — `docs/plans/oss-v0-1-0-publish.md` §3.
...
- `docs/plans/oss-v0-1-0-publish-wire-clis.md` (this plan-doc).
- `docs/plans/oss-v0-1-0-publish-wire-clis.manifest.yaml` (the manifest).
...
1. **Author the manifest.** `docs/plans/oss-v0-1-0-publish-wire-clis.manifest.yaml`.
...
- **Precedent multi-component sealed-amendment manifests:**
  - `docs/plans/oss-v0-1-0-publish-rename-1e.manifest.yaml` (multi-component fence covering reversibility-primitive + safety-layer + cost-governance + self-correction among others).
  - `docs/plans/oss-v0-1-0-publish-rename-1d.manifest.yaml` (M1d — multi-component shape).
- **Precedent single-component sealed-amendment manifest:**
  - `docs/plans/oss-v0-1-0-publish-partition.manifest.yaml` (M2 — for the universal-admissions block precedent + narrative shape).
