...
| **M7.docs-lane** (parallel) | `oss-v0-1-0-publish-public-docs.md` | **Documentary lane** (parallel-safe with M1–M6 builds). Author `docs/positioning.md`, `docs/getting-started.md`, `docs/architecture.md`, `docs/components/<name>.md` (×8), `docs/design/odd.md` (~200-line condensation), rewrite `README.md`. **Multi-artefact authoring → background agents** per `feedback_background_default_for_authoring`. | AC.OSS.5 | 30–60 min | 45 min |
