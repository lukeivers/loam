...
**Parent plan:** `docs/plans/v0-2-0-master-plan.md` §3 Cycle 2 + §4 Cycle 2 dispatch brief.
...
- **Universal admissions:** `docs/plans/` + `docs/design/` + `CLAUDE.md` + `docs/odd-in-loam.md` + `docs/odd-methodology.md` + `docs/STATE.md` (only the ones touched).
...
- v0.2.0 master plan: `docs/plans/v0-2-0-master-plan.md` (committed `7c0f87b`).
- v0.2.0 Cycle 1 sub-plan: `docs/plans/v0-2-0-cycle-1-continuous-watch.md` (sealed `6fef2f1`, apply `faff84e`).
- Layered-skill story research (auto-creation reference): `docs/plans/layered-skill-story-research-2026-05-04.md` §3 + §3.6 universal-tier.
- Eric synthesis (v0.2.0 row authority): `docs/plans/eric-final-delivery-plan-2026-05-04.md` §2 v0.2.0.
- v0.1.7 layered-skill discovery (workspace-local SKILL discovery): `bcf699a`. Plan-doc `docs/plans/v0-1-7-cycle-3-layered-skill-discovery.md`.
- v0.1.7 PM batch API (one-question-at-a-time + record_response): `122a7c8`. Plan-doc `docs/plans/v0-1-7-cycle-4-one-question-pm-flow.md`.
- v0.1.6 production-safety (manifest field shape precedent): `3f1d237`. Plan-doc `docs/plans/v0-1-6-production-safety-and-base-skills.md`.
