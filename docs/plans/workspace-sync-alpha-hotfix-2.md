...
**Companions:**
- **#59 plan-doc** (α-hotfix #1 — fixed the NN branch only): `docs/plans/workspace-sync-alpha-hotfix.md`
- **#57 plan-doc** (Bundle α — introduced the NN ancestor-detection fast-path that #59 + this hotfix repair): `docs/plans/workspace-sync-resolver-cost-overhaul.md`
- **#56 plan-doc** (workspace-sync keystone): `docs/plans/workspace-sync.md`
...
- **HC#1 (no edits outside workspace-sync/) verified.** Seal-diff
  ...
  `docs/plans/` (universal-paths admission) paths in the
  diff.
