...
**Parent plan:** `docs/plans/v0-2-3-master-plan.md` §3 Cycle 1 + §4 Cycle 1 dispatch brief + §6 open items + §9 method-decision register.
...
**TERTIARY admission:** `docs/plans/` (universal-paths admission for the plan-doc paper trail) + `plugins/dev-sdlc/docs/odd-methodology.md` (banding rule extension per Cycle 1 quality bar).
...
Authority: build the 12 AC.OBJX.* family per sub-plan-doc §3. Single-component fence on plugins/dev-sdlc/odd-extractor/. Tertiary admissions: docs/plans/ + plugins/dev-sdlc/docs/odd-methodology.md (banding rule extension).
...
Source pointers (READ FIRST):
  - sub-plan-doc (THIS file's predecessor) at docs/plans/v0-2-3-cycle-1-multi-source-objective-synthesis.md
  - master plan §3 Cycle 1 + §4 Cycle 1 dispatch brief at docs/plans/v0-2-3-master-plan.md (commit 35155fd)
...
- **Master plan:** `docs/plans/v0-2-3-master-plan.md` §3 Cycle 1 + §4 + §6.1/§6.3 + §7 + §9 (commit `35155fd`).
...
- **Sub-plan-doc shape precedent:** `docs/plans/v0-2-1-cycle-1-eric-onboarding-hardening.md` (manifest schema v3; same §1-§7 + §14 structure).
...
Cycle-1 method decisions at §7. Master-plan method decisions at master plan §9 (`docs/plans/v0-2-3-master-plan.md`).
