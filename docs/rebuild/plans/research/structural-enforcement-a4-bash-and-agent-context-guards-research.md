...
**Date:** 2026-04-28
**Spec binding:** `docs/rebuild/spec/pos-v2-objectives-spec.md` line 134–135 — same binding A1+A2+A3 satisfy. A4 closes the four-amendment programme.
...
**A2 research:** `docs/rebuild/plans/research/structural-enforcement-a2-objective-binding-gate-research.md`.
**A3 research:** `docs/rebuild/plans/research/structural-enforcement-a3-tdd-guard-research.md`.
...
**Pre-flight verification:** `git log --grep="A4|bash.guard|agent.guard|bash-and-agent"` returns no A4 amendment commit; `ls docs/rebuild/plans/ | grep -iE "a4|bash.guard|agent.guard"` returns nothing matching `structural-enforcement-a4-*` other than this artefact and its sibling plan-doc. CLEAN at authoring time.
...
- A2 research: `docs/rebuild/plans/research/structural-enforcement-a2-objective-binding-gate-research.md`
- A3 plan (sealed): `docs/rebuild/plans/structural-enforcement-a3-tdd-guard.md`
- A3 research: `docs/rebuild/plans/research/structural-enforcement-a3-tdd-guard-research.md`
- A3 builder plan: `docs/rebuild/plans/structural-enforcement-a3-tdd-guard.builder-plan.md`
- A1 substrate code:
