...
**Source:** memory-system research v1 + v2 (see `docs/archive/component-research/memory-system/`); all revisions confirmed 2026-04-18.
...
**Source:** primary-persona-layer research + proposal + build (see `docs/archive/component-research/primary-persona-loader/`); all revisions confirmed 2026-04-18 18:43.
