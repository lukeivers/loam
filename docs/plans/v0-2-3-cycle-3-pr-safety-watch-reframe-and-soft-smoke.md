...
**Parent plan:** `docs/plans/v0-2-3-master-plan.md` §3 Cycle 3 + §4 Cycle 3 dispatch brief + §5 release-level SOFT smoke + §9 method-decision register.
...
**PRIMARY:** `plugins/dev-sdlc/pr-safety/`. **SECONDARY:** `plugins/dev-sdlc/odd-extractor/` (incremental engine reframe + legacy `acs:` retirement). **TERTIARY:** `docs/plans/` (plan-doc paper trail). Single-seal under shared dev-sdlc parent per v0.1.8 + Cycle 2 precedent.
...
Source pointers (READ FIRST):
  - THIS sub-plan-doc at
    docs/plans/v0-2-3-cycle-3-pr-safety-watch-reframe-and-soft-smoke.md
  - master plan §3 Cycle 3 + §4 + §5 + §9 at
    docs/plans/v0-2-3-master-plan.md (commit 35155fd)
...
- **Master plan:** `docs/plans/v0-2-3-master-plan.md` §3 Cycle 3 + §4 + §5 + §6 + §9 (`35155fd`).
- **Cycle 1 sub-plan-doc:** `docs/plans/v0-2-3-cycle-1-multi-source-objective-synthesis.md`. Sealed `9b9f87c`.
- **Cycle 2 sub-plan-doc:** `docs/plans/v0-2-3-cycle-2-backing-map-and-ratification-reframe.md`. Apply `716da0a`; seal `857749c`; master §9 backfill `06779c4`.
...
Cycle-3 method decisions at §7. Master-plan method decisions at master plan §9 (`docs/plans/v0-2-3-master-plan.md`). Cycle 1 method decisions at `docs/plans/v0-2-3-cycle-1-multi-source-objective-synthesis.md` §7. Cycle 2 method decisions at `docs/plans/v0-2-3-cycle-2-backing-map-and-ratification-reframe.md` §7.
