...
Requires Claude Code v2.1.208 or later; attaching with Enter requires v2.1.216 /autocompact [auto|<tokens>] Set the auto-compact window: how full the context window gets before Claude Code compacts automatically.
