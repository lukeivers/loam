...
`docs/plans/research/amendment-25-bge-reranker-swap-research.md`.
Manifest: `docs/plans/amendment-25-bge-reranker-swap.manifest.yaml`.
...
`docs/archive/component-research/memory-system/proposal.md` — add a note in
...
`docs/plans/amendment-25-bge-reranker-swap.manifest.yaml`:
...
- No extra allowed prefixes needed — `memory-system/` and
  `docs/archive/component-research/memory-system/` are both already in the
