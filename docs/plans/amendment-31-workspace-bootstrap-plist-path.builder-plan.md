...
`workspace-bootstrap/` and `docs/plans/`, plus universal
...
1. Create `docs/plans/amendment-31-workspace-bootstrap-plist-path.manifest.yaml`.
...
- Amendment commit touches:
  ...
  - `docs/plans/amendment-31-workspace-bootstrap-plist-path.manifest.yaml` (new)
  - `docs/plans/amendment-31-workspace-bootstrap-plist-path.md` (rename from unnumbered file)
  - `docs/plans/amendment-31-workspace-bootstrap-plist-path.builder-plan.md` (this file)
  - Research docs are already untracked; include under
    `docs/plans/research/` in the same commit.
