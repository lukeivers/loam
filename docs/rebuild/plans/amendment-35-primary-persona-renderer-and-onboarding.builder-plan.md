...
| `primary-persona/tests/test_no_sealed_amendments.py` | BASELINE advance + allowed-prefixes unchanged (still `primary-persona/` + `docs/rebuild/plans/` + universal files) | AC35.S |
...
| `docs/rebuild/plans/amendment-35-*.manifest.yaml` | new manifest file | bookkeeping |
| `docs/rebuild/plans/amendment-35-*.builder-plan.md` | this file | bookkeeping |
| `docs/rebuild/plans/amendment-35-*.md` | already exists; append §14 method-decision record + commit SHAs | bookkeeping |
| `docs/rebuild/plans/amendment-36-*.md` | already exists; no edit unless explicitly required | n/a |
| `docs/rebuild/plans/amendment-37-*.md` | already exists; no edit unless explicitly required | n/a |
| `docs/rebuild/plans/first-run-*.md` | already exists; no edit | n/a |
...
10. Author manifest yaml at
    `docs/rebuild/plans/amendment-35-primary-persona-renderer-and-onboarding.manifest.yaml`.
