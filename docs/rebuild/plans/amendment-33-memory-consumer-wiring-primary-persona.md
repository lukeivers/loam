...
`docs/rebuild/plans/research/memory-consumer-wiring-research.md`.
Sibling D8 research for shared-composer context:
`docs/rebuild/plans/research/session-start-context-load-gate-research.md`.
...
- `docs/rebuild/plans/amendment-memory-consumer-wiring-primary-persona*`,
- `docs/rebuild/plans/research/memory-consumer-wiring-research*`,
...
- **Universal admissions** per amendment #22 ruling #3:
  ...
  - `universal_paths.files`: `CLAUDE.md`,
    ...
    `docs/rebuild/FUTURE_IDEAS.md`, `docs/rebuild/STATE.md`,
...
- Primary-persona layer proposal:
  `docs/rebuild/components/primary-persona-loader/proposal.md`
