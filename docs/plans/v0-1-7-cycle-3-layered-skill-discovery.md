...
**Parent plan:** `docs/plans/v0-1-7-personas-pm-layered-skills.md` §5 AC.LAYERED.* family + §6 Cycle 3.
...
`docs/plans/layered-skill-story-research-2026-05-04.md` §1.4.
...
- Universal-admitted artefacts:
  - `docs/plans/v0-1-7-cycle-3-layered-skill-discovery.md` (this doc).
  - `docs/plans/v0-1-7-cycle-3-layered-skill-discovery.manifest.yaml`.
