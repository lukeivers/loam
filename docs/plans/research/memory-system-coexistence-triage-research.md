...
plan at `docs/plans/memory-system-live-client-and-stop-hook-write.md`),
...
verified in `docs/plans/research/`). This artefact stands on
...
- Memory-system component research (cites Claude Code memory as
  candidate #8): `docs/archive/component-research/memory-system/research.md`
