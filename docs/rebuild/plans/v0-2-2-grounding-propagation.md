...
**Parent plan:** `docs/rebuild/plans/odd-rebuild-master-plan-2026-05-05.md` §3 v0.2.2.
...
Source pointers (READ FIRST):
  - sub-plan-doc at docs/rebuild/plans/v0-2-2-grounding-propagation.md (THIS file's predecessor)
  - master plan at docs/rebuild/plans/odd-rebuild-master-plan-2026-05-05.md §3 v0.2.2
...
Sub-plan path: docs/rebuild/plans/v0-2-2-grounding-propagation.md (this plan-doc).
Manifest path: docs/rebuild/plans/v0-2-2-grounding-propagation.manifest.yaml.
...
| Universal-paths admissions | `docs/rebuild/plans/` + `CLAUDE.dev.md` + the inline-hook file path | Per amendment #22 ruling #3 + Cycle 3 + v0.1.9 + v0.2.0 + v0.2.1 precedent. |
...
v0.2.2 method decisions at §7. Master-plan method decisions at master plan §7 (`docs/rebuild/plans/odd-rebuild-master-plan-2026-05-05.md`).
