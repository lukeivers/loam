...
**Parent plan:** `docs/rebuild/plans/eric-final-delivery-plan-2026-05-04.md` §2 v0.2.1 — AUTHORITATIVE.
**Companion research:** `docs/rebuild/plans/layered-skill-story-research-2026-05-04.md` §4 (promotion rubric); `docs/rebuild/plans/v0-2-0-master-plan.md` (release rollup `bbc93a7`); `plugins/dev-sdlc/docs/smoke-test-discipline.md`.
...
Plan-author dispatch (plan-before-code). Output: `docs/rebuild/plans/v0-2-1-cycle-1-eric-onboarding-hardening.md` (sub-plan-doc) + `.manifest.yaml`.
...
Plan-author dispatch. Output: `docs/rebuild/plans/v0-2-1-cycle-2-promotion-rubric.md` + `.manifest.yaml`.
...
- **Master plan source authority:** `docs/rebuild/plans/eric-final-delivery-plan-2026-05-04.md` §2 v0.2.1 + Decisions L / G / Q / P / R / S.
- **Layered-skills promotion rubric:** `docs/rebuild/plans/layered-skill-story-research-2026-05-04.md` §4 (lines 261–323).
- **v0.2.0 master plan precedent:** `docs/rebuild/plans/v0-2-0-master-plan.md` (rollup `bbc93a7`).
...
|---|---|---|---|
| Cycle 1 | Eric onboarding ritual hardening | TBD | TBD |
