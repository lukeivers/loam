...
**Parent plan:** `docs/plans/odd-rebuild-master-plan-2026-05-05.md` §3 v0.2.4 — AUTHORITATIVE.
...
- **Source authority:** `docs/plans/odd-rebuild-master-plan-2026-05-05.md` §3 v0.2.4 + §3 v0.2.5/v0.2.6 split per Luke 2026-05-05.
...
- **Shape precedents:** `docs/plans/v0-2-3-master-plan.md`; `v0-2-3-cycle-1-multi-source-objective-synthesis.md`; `v0-2-1-cycle-1-eric-onboarding-hardening.md` (PM batch API consumption).
