...
**Parent plan:** `docs/plans/v0-1-0-foldback-scope-expansion.md` (FBE.7 added post-FBE.2; parent §8 register is backfilled by this amendment).
...
- `docs/plans/v0-1-0-foldback-scope-expansion-fbe7.md` (this file).
- `docs/plans/v0-1-0-foldback-scope-expansion-fbe7.manifest.yaml`.

### Parent plan-doc backfill (post-seal, separate commit):

- `docs/plans/v0-1-0-foldback-scope-expansion.md` — §8 method-decision register: ADD a NEW `### FBE.7 — Drop graphiti from v0.1.0 first-run shape` subsection with apply commit SHA + seal commit SHA. The parent plan was authored before FBE.7 existed; this is a structural addition.
...
3. **Manifest commit** — author `docs/plans/v0-1-0-foldback-scope-expansion-fbe7.manifest.yaml`.
...
6. **Parent plan-doc backfill** — `docs/plans/v0-1-0-foldback-scope-expansion.md` §8 add NEW `### FBE.7` subsection with apply + seal SHAs (separate NEW commit; admitted via `docs/plans/` universal prefix).
...
- **Parent plan:** `docs/plans/v0-1-0-foldback-scope-expansion.md` (§8 backfilled by FBE.7 itself).
- **Memory-pivot plan:** `docs/plans/oss-v0-1-0-publish-memory-pivot.md` (M-FBM ACs already met inside primary-persona).
...
- **FBE.1 sub-plan / manifest YAML (shape precedent):** `docs/plans/v0-1-0-foldback-scope-expansion-fbe1.{md,manifest.yaml}`.
- **FBE.2 sub-plan / manifest YAML:** `docs/plans/v0-1-0-foldback-scope-expansion-fbe2.{md,manifest.yaml}`.
