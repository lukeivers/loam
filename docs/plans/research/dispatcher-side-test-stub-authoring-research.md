...
**Sibling plan-doc:** `docs/plans/dispatcher-side-test-stub-authoring.md`.
**Captures (FIDRAFT):** `docs/FUTURE_IDEAS_DRAFT.md` line 151 — "Dispatcher-side test-stub authoring" (captured 2026-04-28 by amendment #71 (A3) build agent).
**Composes on (sealed):**
...
`ls docs/plans/ | grep -iE "test.stub|dispatch.*stub"` returns nothing.
...
- FIDRAFT capture: `docs/FUTURE_IDEAS_DRAFT.md` line 151.
- Amendment #52 plan: `docs/plans/agent-dispatch-as-scope-wrapper.md`.
- Amendment #52 wrapper code: `framework/primary-persona/src/dispatch_wrapper.py`.
- Amendment #52 manifest: `docs/plans/agent-dispatch-as-scope-wrapper.manifest.yaml`.
- Amendment #51 (A1) substrate plan: `docs/plans/structural-enforcement-a1-substrate.md`.
...
- Amendment #70 (A2) plan: `docs/plans/structural-enforcement-a2-objective-binding-gate.md`.
- Amendment #70 (A2) gate code: `framework/hands-off-lifecycle/hooks/objective_binding_gate.py`.
- Amendment #71 (A3) plan: `docs/plans/structural-enforcement-a3-tdd-guard.md`.
