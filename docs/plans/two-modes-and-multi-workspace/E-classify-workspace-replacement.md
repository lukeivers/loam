...
`"pos-v2-dev"` when `docs/VALUE_PROPOSITION.md` is present at
...
unchanged: dev workspaces still read `docs/VALUE_PROPOSITION.md`,
...
`docs/VALUE_PROPOSITION.md`. A workspace where
...
`"pos-v2-dev"`, it reads `docs/VALUE_PROPOSITION.md` (or the
