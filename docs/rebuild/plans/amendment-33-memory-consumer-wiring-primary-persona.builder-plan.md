...
**Governing plan:**
`docs/rebuild/plans/amendment-memory-consumer-wiring-primary-persona.md`.
...
- Manifest filename:
  `docs/rebuild/plans/amendment-33-memory-consumer-wiring-primary-persona.manifest.yaml`.
...
2. Rename governing plan + research files; commit trivially under
   ...
   requires admission under `docs/rebuild/plans/` which is
