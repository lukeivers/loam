...
sub-tree (e.g. ``tools/**`` minus ``tools/pos-amend/**``).
"""
...
def test_AC_F4_glob_with_exclusion(tmp_path: Path) -> None:
    """``glob: tools/**`` with ``exclude: [tools/pos-amend/**]``
    ...
    candidates = [
        ...
        "tools/pos-amend/src/pos_amend/cli.py",
        "tools/pos-amend/pyproject.toml",
        "tools/orphan-plist-cleanup/README.md",
        "docs/CLAUDE_CAPABILITIES.md",
    ]
    entry = ManifestEntry(
        glob="tools/**",
        exclude=("tools/pos-amend/**",),
    )
