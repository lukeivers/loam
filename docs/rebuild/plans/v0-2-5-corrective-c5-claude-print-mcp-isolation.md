...
2. **Scope fence.** Edits limited to:
   ...
   - `docs/rebuild/plans/v0-2-5-corrective-c5-claude-print-mcp-isolation.{md,manifest.yaml}`
...
9. Author manifest at `docs/rebuild/plans/v0-2-5-corrective-c5-claude-print-mcp-isolation.manifest.yaml`.
