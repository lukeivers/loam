...
**Programme master:** `docs/plans/oss-v0-1-0-publish.md` — this series slots into §5 work decomposition (placement proposed §6 below).
...
- Programme master: `docs/plans/oss-v0-1-0-publish.md` §3 prime ACs AC.OSS.1–7; §5 work decomposition; §6 sequencing; §13 decisions register.
...
- **Plugin precedent:** `framework/plugins/dev-sdlc/{pyproject.toml,dev-mode-manifest.yaml}`;
  `docs/plans/oss-v0-1-0-publish-dev-sdlc-plugin.md`.
- **Partition manifest:**
