...
**Authored:** 2026-04-23.
**Research:** `docs/plans/research/amendment-28-workspace-identity-routed-first-run-research.md`
...
`hands-off-lifecycle/`,
`docs/plans/amendment-28-workspace-identity-routed-first-run*`,
`docs/plans/research/amendment-28-*`,
`docs/FUTURE_IDEAS.md` (Idea 9 catalogue update), and paths
