...
2. **Scope fence.** Edits limited to:
   ...
   - `.gitignore` (add `.loam/`)
   - `docs/plans/v0-2-5-corrective-c6-fixture-pm-and-extraction-resolution.{md,manifest.yaml}`
...
10. Author manifest at `docs/plans/v0-2-5-corrective-c6-fixture-pm-and-extraction-resolution.manifest.yaml`.
...
plan: docs/plans/v0-2-5-corrective-c6-fixture-pm-and-extraction-resolution.md
plan_doc_ref: docs/plans/v0-2-5-corrective-c6-fixture-pm-and-extraction-resolution.md
ac_count: 5
...
- v0.2.5 corrective C5 plan-doc: `docs/plans/v0-2-5-corrective-c5-claude-print-mcp-isolation.md`
