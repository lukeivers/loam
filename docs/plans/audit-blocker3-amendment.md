...
## What I'm auditing
1. Proposal: `docs/archive/component-research/memory-system-subscription-routed-llm/proposal.md`
2. Preserved-research: `docs/archive/component-research/memory-system-gliner2-expansion/research.md`
