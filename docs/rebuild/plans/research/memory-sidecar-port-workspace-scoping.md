...
- `docs/rebuild/FUTURE_IDEAS.md` Idea 9 (slug-collision detection; explicitly
...
2. **Spec objective coverage — HALT TRIGGER #1 HIT.** No objective in
   `docs/rebuild/spec/pos-v2-objectives-spec.md` v1.0, v1.1, or v1.2
...
**Primary-source file:**
`docs/rebuild/spec/pos-v2-objectives-spec.md` (356 lines).
...
state — a sibling concern to the one `docs/rebuild/FUTURE_IDEAS.md`
...
- `docs/rebuild/plans/amendment-28-workspace-identity-routed-first-run.md`
  ...
  compliance note.
- `docs/rebuild/plans/research/amendment-28-workspace-identity-routed-first-run-research.md`
  — §4 "Why this is distinct from Idea 9", §5 options A/B/C
  precedent that §7 mirrors.
- `docs/rebuild/FUTURE_IDEAS.md` Idea 9 — slug-collision; 2026-04-23
  update noting state-routing closed, label-slug still open.
- `docs/rebuild/plans/amendment-24-memory-system-mcp-migration.md:92-99`
  — AC24.6, env-var contract `GRAPHITI_SERVICE_HOST` /
  `GRAPHITI_SERVICE_PORT`.
- `docs/rebuild/spec/pos-v2-objectives-spec.md` — survey (zero
