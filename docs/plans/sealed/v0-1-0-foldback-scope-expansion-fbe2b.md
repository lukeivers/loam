...
**Parent plan:** `docs/plans/v0-1-0-foldback-scope-expansion.md` §3 Decision D + §4 (newly-inserted FBE.2b row).
...
- `docs/plans/v0-1-0-foldback-scope-expansion-fbe2b.md` (this file).
- `docs/plans/v0-1-0-foldback-scope-expansion-fbe2b.manifest.yaml`.
...
YAML + parent backfill ride via `docs/plans/`
universal-paths.
...
- Parent plan: `docs/plans/v0-1-0-foldback-scope-expansion.md` §3 Decision D + §4 register.
- FBE.2 status (Surface #1 + Risk #7 — synth strip rationale): `<workspace>/.scratch/claude-output/fbe2-status-2026-05-03.md`.
- FBE.2 sub-plan (sealed-component sidecar shape mirror): `docs/plans/v0-1-0-foldback-scope-expansion-fbe2.md`.
- FBE.2 manifest (universal-paths admission shape mirror): `docs/plans/v0-1-0-foldback-scope-expansion-fbe2.manifest.yaml`.
