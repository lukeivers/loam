...
**Companions:**
- **#57 plan-doc** (Bundle α — introduced the NN ancestor-detection fast-path that this hotfix repairs): `docs/rebuild/plans/workspace-sync-resolver-cost-overhaul.md`
- **#56 plan-doc** (workspace-sync keystone — defines the stage-then-apply envelope this fix preserves): `docs/rebuild/plans/workspace-sync.md`
