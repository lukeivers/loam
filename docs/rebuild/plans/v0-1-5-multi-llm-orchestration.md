...
Proposed update to `docs/rebuild/plans/v0-1-x-roadmap.md`:
...
Replace the existing v0.1.5 section in `docs/rebuild/plans/v0-1-x-roadmap.md` §2 (whichever version is currently there post-reconciliation) with:
...
>
> **Bundle:** see `docs/rebuild/plans/v0-1-5-multi-llm-orchestration.md` §5 for AC table and component breakdown. Five components C1-C5 (~10-16 h AI-time).
>
...
Add a v0.1.6 section to `docs/rebuild/plans/v0-1-x-roadmap.md` §2:
...
>
> **Bundle:** see `docs/rebuild/plans/v0-1-5-multi-llm-orchestration.md` §5 for AC table (AC.MLR.10-14). Four components C6-C9 (~8-16 h AI-time).
>
...
Update v0.2.0 section in `docs/rebuild/plans/v0-1-x-roadmap.md` §3 (deferred items) to land memory-pluggable as a v0.2.0 component.

### §9.5 Sequencing diagram update

Update the diagram in §4 of `docs/rebuild/plans/v0-1-x-roadmap.md` to:
...
5. **Plan inconsistency:** if this plan-doc and the roadmap (`docs/rebuild/plans/v0-1-x-roadmap.md`) disagree on what v0.1.5 is at build time. Halt; align before building.
