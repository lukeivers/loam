...
**Research plan:** `docs/plans/research/session-start-context-load-gate-research-plan.md`
...
`docs/plans/`, (c) service-state fields for the memory
...
`primary-persona/`,
`docs/plans/amendment-session-start-context-load-gate*`,
`docs/plans/research/session-start-context-load-gate-*`,
...
- **Universal-paths admissions.** Plan + research docs under
  ...
  `docs/odd-in-pos.md`, `docs/FUTURE_IDEAS.md` included on
