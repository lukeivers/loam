...
**Companions:** `docs/plans/pos-amend-seal-automation-extension.md` (just landed; this plan composes on top), `docs/plans/pos-amend-tracker-integration.md` (queued; orthogonal).
**Ancestor record:** `docs/FUTURE_IDEAS_DRAFT.md` entries "Dispatch-prompt template family", "Plan-doc skeleton template", "Memory-doc skeleton template", "Commit-message templates per category".
...
3. Write builder-plan to `docs/plans/dispatch-prompt-template-extension.builder-plan.md` naming specific files + symbols expected to be touched.
