...
Seven `brief.md` files live under `docs/archive/component-research/<comp>/` inside
...
1. `docs/archive/component-research/primary-persona-loader/brief.md` (214 lines)
2. `docs/archive/component-research/session-resilient-orchestrator/brief.md` (209 lines)
3. `docs/archive/component-research/graceful-degradation/brief.md` (212 lines)
4. `docs/archive/component-research/observability-aggregator/brief.md` (198 lines)
5. `docs/archive/component-research/cost-governance/brief.md` (128 lines)
6. `docs/archive/component-research/scope-of-work/brief.md` (175 lines)
7. `docs/archive/component-research/objective-tracker/brief.md` (192 lines)
...
"docs/plans/", "hands-off-lifecycle/")`, `allowed_files = set()`.

Add to `allowed_prefixes`:
- `docs/archive/component-research/cost-governance/` (brief.md deletion lives here)
...
Add to `allowed_prefixes`:
- `docs/archive/component-research/graceful-degradation/`
- `docs/plans/` (plan-before-code paper trail)
...
Add to `allowed_prefixes`:
- `docs/archive/component-research/observability-aggregator/`
- `docs/plans/`
- `hands-off-lifecycle/`
...
`docs/plans/`, `data/`. `allowed_files = {"first-run-inventory.yaml"}`.

Add to `allowed_prefixes`:
- `docs/archive/component-research/session-resilient-orchestrator/` (brief.md
