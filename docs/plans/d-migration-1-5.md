...
**Companions:**
- **D-migration parent plan:** `docs/plans/d-migration.md`
...
- **D.1 builder plan §8 (post-build register):**
  `docs/plans/d-migration-1.builder-plan.md` §8 — records
  the hand-rolled seal flow + names this gap explicitly.
- **Vars-file:** `docs/plans/d-migration-1-5.vars.yaml`.
...
2. **Author builder-plan** at
   `docs/plans/d-migration-1-5.builder-plan.md`
...
7. **Author manifest** at
   `docs/plans/d-migration-1-5.manifest.yaml` per
...
12. **`pos-amend seal --plan-doc /Users/lukeivers/ivers-corp-pos-v2/docs/plans/d-migration-1-5.md
...
plan: docs/plans/d-migration-1-5.md
...
Companion vars-file at `docs/plans/d-migration-1-5.vars.yaml`.
