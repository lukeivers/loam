...
**Companion plan:** `docs/rebuild/plans/workspace-sync-alpha-hotfix.md` (§1-§5 + AC.α-hotfix.1 + AC.α-hotfix.S).
...
Plan-doc: docs/rebuild/plans/workspace-sync-alpha-hotfix.md
Builder-plan: docs/rebuild/plans/workspace-sync-alpha-hotfix.builder-plan.md
Manifest: docs/rebuild/plans/workspace-sync-alpha-hotfix.manifest.yaml
```
