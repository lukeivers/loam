...
`docs/plans/workspace-sync-resolver-cost-overhaul.manifest.yaml`),
...
**Companions:** - **#56 plan-doc:** `docs/plans/workspace-sync.md`
  (1377 lines including §14 method-decision register; the
  keystone plan whose resolver subsystem this amendment
  extends).
- **#56 builder-plan:** `docs/plans/workspace-sync.builder-plan.md`
...
- **Spec anchors:**
  `docs/spec/pos-v2-objectives-spec.md` line 81
...
4. **Plan-before-code.** This plan exists; the builder
   ...
   `docs/plans/workspace-sync-resolver-cost-overhaul.builder-plan.md`
...
1. **Read session-start corpus + this plan + #56's plan-doc**
   (`docs/plans/workspace-sync.md`, especially §14
...
plan: docs/plans/workspace-sync-resolver-cost-overhaul.md
...
universal_paths:
  ...
  files:
    ...
    - docs/FUTURE_IDEAS_DRAFT.md  # entries graduate / retire post-seal
...
Full detail in `docs/plans/workspace-sync-resolver-cost-overhaul.builder-plan.md` §A. One-line summary per choice:
