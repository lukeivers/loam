...
**Authored:** 2026-04-24.
**Research plan:** `docs/rebuild/plans/research/workspace-bootstrap-plist-env-research-plan.md`.
**Research doc:** `docs/rebuild/plans/research/workspace-bootstrap-plist-env-research.md`.
...
research docs under `docs/rebuild/plans/`, plus universal-paths
admissions (`CLAUDE.md`, `docs/odd-in-pos.md`,
`docs/odd-methodology.md`, `docs/rebuild/FUTURE_IDEAS.md`). If
...
1. Manifest: `docs/rebuild/plans/amendment-<N>-workspace-bootstrap-plist-path.manifest.yaml`.
...
`universal_paths.prefixes`: `docs/rebuild/plans/` (universal).
`universal_paths.files`: `CLAUDE.md`, `docs/odd-in-pos.md`,
`docs/odd-methodology.md`, `docs/rebuild/FUTURE_IDEAS.md` (universal).
