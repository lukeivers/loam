...
**Parent plan:** `docs/rebuild/plans/v0-2-4-master-plan.md` §3 Cycle 2 + §9.
...
- **Master plan:** `docs/rebuild/plans/v0-2-4-master-plan.md` §3 Cycle 2 + §7.2 + §9 (commit `f230333`).
...
- **Cycle 1 sub-plan-doc precedent:** `docs/rebuild/plans/v0-2-4-cycle-1-completeness-interview.md` (committed `36ca3e2`); seal at `d42ace9`.
...
13. ✓ Manifest companion authored at `docs/rebuild/plans/v0-2-4-cycle-2-gap-analysis.manifest.yaml`.

---

## 14. Method-decision record (per AC.D-sa.7 lint requirement)

Cycle-2 method decisions at §7. Master-plan method decisions at master plan §9 (`docs/rebuild/plans/v0-2-4-master-plan.md`).
