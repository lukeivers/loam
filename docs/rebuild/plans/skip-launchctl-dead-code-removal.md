...
**Secondary surfaces:**
- `docs/rebuild/plans/skip-launchctl-dead-code-removal.md` — this plan.
...
3. `docs/rebuild/plans/skip-launchctl-dead-code-removal.md` — this plan (new file).
