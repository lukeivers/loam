...
**Parent plan:** `docs/plans/v0-1-0-foldback-scope-expansion.md` §4 FBE.2.
...
- **AC.PO.1 + AC.PO.2** (prime objective per
  `docs/VALUE_PROPOSITION.md`) — making the documented
...
- `docs/plans/v0-1-0-foldback-scope-expansion-fbe2.md` (this file).
...
3. **Partition-admission commit** — edit `publish-mode-manifest.yaml`
   ...
   passes 3/3.
4. **Manifest commit** — author `docs/plans/v0-1-0-foldback-scope-expansion-fbe2.manifest.yaml`.
...
7. **Parent plan-doc backfill** — `docs/plans/v0-1-0-foldback-scope-expansion.md`
   §8 FBE.2 entries get the apply + seal SHAs (separate NEW commit;
   admitted via `docs/plans/` universal prefix).
...
- **FBE.1 sub-plan:** `docs/plans/v0-1-0-foldback-scope-expansion-fbe1.md`.
- **FBE.1 manifest YAML (shape precedent):** `docs/plans/v0-1-0-foldback-scope-expansion-fbe1.manifest.yaml`.
...
- **Universal-paths-admission precedent:** `docs/plans/oss-v0-1-0-publish-public-docs-partition-fix.manifest.yaml` (M7-partition-fix amendment #98) + FBE.1 manifest.
