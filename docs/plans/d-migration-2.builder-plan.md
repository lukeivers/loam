...
This builder-plan refines the parent plan `docs/plans/d-migration.md` §4 D.2 with the wider-fence ACs. Method shape is the builder's call within the AC outcome bound; this plan records it for review.
