...
Companion to `docs/plans/amendment-39-workspace-bootstrap-
...
- **D-build.1 — pos-v2-dev classifier.** Candidate (a): detect by
  presence of `docs/VALUE_PROPOSITION.md` at the workspace
...
- `docs/plans/amendment-39-workspace-bootstrap-tracker-seed.manifest.yaml`
  — pos-amend manifest.
...
- The "template source" for pos-v2 dev workspaces is the
  canonical doc `docs/VALUE_PROPOSITION.md` itself, READ at
...
- Single tree: there is exactly ONE `docs/VALUE_PROPOSITION.md`
  ...
  `docs/VALUE_PROPOSITION.md` with their own content; the
