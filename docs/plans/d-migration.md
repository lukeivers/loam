...
- **Research note (D-D1 ruling on merits):**
  `docs/plans/research/workspace-architecture-directory-split-2026-04-27.md`
...
- **Architecture being migrated FROM:**
  - `docs/plans/workspace-sync.md` (#56 — keystone B-mode)
  - `docs/plans/workspace-sync-resolver-cost-overhaul.md` (#57 — α NN fast-path)
  - `docs/plans/workspace-sync-alpha-hotfix.md` (#59 — α-hotfix #1)
  - `docs/plans/workspace-sync-alpha-hotfix-2.md` (#60 — α-hotfix #2)
- **Spec anchors:** `docs/VALUE_PROPOSITION.md` (AC.PO.1 +
...
- **Vars-file (rendered companion):**
  `docs/plans/d-migration.vars.yaml` — top-level
...
1. `docs/plans/research/workspace-architecture-directory-split-2026-04-27.md`
...
`docs/STATE.md` entry.** The verb is discoverable
...
`docs/plans/d-migration-D.x.builder-plan.md` (or per
...
- Author builder-plan at
  `docs/plans/d-migration-D.x.builder-plan.md` before
  any source edit.
