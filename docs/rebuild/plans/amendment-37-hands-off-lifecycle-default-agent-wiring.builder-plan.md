...
- `docs/rebuild/plans/amendment-37-hands-off-lifecycle-default-agent-wiring.manifest.yaml` — author following #35/#36 pattern. BASELINE = HEAD~1 of the amendment commit. `frozen_baseline: true` for hands-off-lifecycle (amendment #23).
- `docs/rebuild/plans/amendment-37-hands-off-lifecycle-default-agent-wiring.md` — append §14 method-decision record.
