...
**Parent plan:** `docs/rebuild/plans/v0-2-1-master-plan.md` §3 Cycle 1 + §4 Cycle 1 dispatch brief.
...
- **AC.ONBOARD.13 — Install docs updated at quality-bar feel-intentional level.**
  ...
  - Fence component: `docs/` (universal-paths admission per `docs/rebuild/plans/` precedent).
...
Source pointers (READ FIRST):
  - sub-plan-doc (THIS file's predecessor) at docs/rebuild/plans/v0-2-1-cycle-1-eric-onboarding-hardening.md
  - master plan §3 Cycle 1 + §4 Cycle 1 dispatch brief at docs/rebuild/plans/v0-2-1-master-plan.md
  - Decisions Q + P at parent docs/rebuild/plans/eric-final-delivery-plan-2026-05-04.md §3
