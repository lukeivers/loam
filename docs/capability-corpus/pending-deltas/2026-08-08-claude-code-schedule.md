...
- **new-claim** — adds a capability claim not previously upstream
  - now: With a Console API key, submitting /schedule instead shows /schedule is available with Claude for Enterprise — ask your admin about migrating from API-key access .
