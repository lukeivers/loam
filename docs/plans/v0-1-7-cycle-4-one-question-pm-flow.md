...
**Parent plan:** `docs/plans/v0-1-7-personas-pm-layered-skills.md` §5 AC.QSURF.* family + §6 Cycle 4.
...
- Universal-admitted artefacts:
  - `docs/plans/v0-1-7-cycle-4-one-question-pm-flow.md` (this doc).
  - `docs/plans/v0-1-7-cycle-4-one-question-pm-flow.manifest.yaml`.

- **Release-close bookkeeping (deferred to a follow-on doc-only commit
  after the seal lands; OUTSIDE the seal-fence):**
  - `docs/STATE.md` v0.1.7 row.
  - `docs/plans/v0-1-x-roadmap.md` §8 v0.1.7 register entry.
