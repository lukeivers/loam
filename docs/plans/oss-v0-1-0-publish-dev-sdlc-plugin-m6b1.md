...
**Master plan:** `docs/plans/oss-v0-1-0-publish-dev-sdlc-plugin.md` (AC.OSS-M6.15 + §10 D-build.M6.15 — shadow-then-flip migration shape; §6.5.4 ship-shape).
...
All ACs ladder up to master plan AC.OSS-M6.15 → AC.OSS.6 → AC.PO.1 + AC.PO.2 (prime objective per `docs/VALUE_PROPOSITION.md` per `feedback_value_proposition_as_prime_objective`).
