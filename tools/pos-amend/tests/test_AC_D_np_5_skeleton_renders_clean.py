...
Per `docs/rebuild/plans/pos-amend-new-plan-orchestration.md`:
    ...
    The post-extension ``tools/pos-amend/templates/plan/dev-discipline.md``
...
def test_AC_D_np_5_skeleton_renders_byte_identical_to_fixture(
    ...
    assert actual == expected, (
        ...
        "  pos-amend template render plan/dev-discipline "
        "--vars-file tools/pos-amend/tests/fixtures/plan-skeleton/vars.yaml "
        "--out tools/pos-amend/tests/fixtures/plan-skeleton/expected.md "
        "--force"
    )
