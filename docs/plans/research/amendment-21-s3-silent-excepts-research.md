...
- `telegram-interface/tests/test_no_sealed_amendments.py` — current
  ...
  "docs/archive/component-research/telegram-interface/",
  "docs/archive/component-research/telegram-interface-framework-integration/",
  "docs/plans/", "workspace-bootstrap/",
...
- `memory-system/tests/test_no_sealed_amendments.py` — current
  ...
  "docs/archive/component-research/memory-system-subscription-routed-llm/",
  "docs/archive/component-research/memory-system-gliner2-expansion/",
  "docs/plans/", "data/")`. Needs `scope-of-work/` and
