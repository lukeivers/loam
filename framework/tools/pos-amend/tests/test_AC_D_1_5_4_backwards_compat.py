...
def test_AC_D_1_5_4_existing_pos_amend_test_suite_still_green() -> None:
    """The pre-D.1.5 pos-amend test suite (every test except this
    ...
    assert proc.returncode == 0, (
        "pre-D.1.5 pos-amend test suite regressed under D.1.5 changes:\n"
        + proc.stdout
        + proc.stderr
    )
