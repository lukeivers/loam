...
- Builder-plan: `docs/plans/workspace-bootstrap-framework-only-to-main.builder-plan.md`
- Manifest: `docs/plans/workspace-bootstrap-framework-only-to-main.manifest.yaml`
...
**Surfaced from:** `docs/plans/oss-dev-architecture-survey-and-migration-2026-05-04.md`
...
3. Update the test conftest (`framework/workspace-bootstrap/tests/conftest.py`)
   ...
   - Remove dependency on `loam.publish_framework_only.synth.synthesise_framework_only`
     ...
     `docs/archive/synthesis-tool-2026-05-04/`; can't be
...
6. Backfill seal SHA into:
   - `docs/STATE.md` Change log
   - `docs/plans/eric-final-delivery-plan-2026-05-04.md`
...
- Does NOT import `loam.publish_framework_only.synth` (the module
  is in `docs/archive/synthesis-tool-2026-05-04/`, no
...
`docs/STATE.md`, `docs/FUTURE_IDEAS_DRAFT.md`)
...
1. Backfill seal SHA into:
   - `docs/STATE.md` Change log (new dated entry).
