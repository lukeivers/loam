...
Sealed-component amendment to `self-upgrade/` (follow-on bugfix to amendment #54). Carries a `pos-amend` manifest at `docs/rebuild/plans/self-upgrade-bb-feat-bugfix.manifest.yaml`; advances `self-upgrade/tests/SEAL_COMMIT` sidecar; lands a deterministic seal commit per `pos-amend seal`. Plan-before-code per the dev CDC. Per amendment #54 / #53 precedent.

**Status:** plan (pre-dispatch). 2026-04-26.
**Working directory:** /Users/lukeivers/ivers-corp-pos-v2/
**Companions:** - **#54 plan:** `docs/rebuild/plans/self-upgrade-clause-h-llm-merge.md`
  (the amendment whose ACs this bugfix is closing).
- **#54 manifest:** `docs/rebuild/plans/self-upgrade-clause-h-llm-merge.manifest.yaml`
  (BASELINE + universal paths + narrative shape precedent).
- **CC synthetic-validation test plan:**
  `docs/rebuild/plans/research/bb-feat-synthetic-validation-plan.md`
...
**Research:** docs/rebuild/plans/research/bb-feat-synthetic-validation-plan.md
...
(`docs/rebuild/plans/self-upgrade-clause-h-llm-merge.md`). Each
...
objective (line 81 of `docs/rebuild/spec/pos-v2-objectives-spec.md`).
...
4. **Plan-before-code.** This plan exists; the builder writes a
   builder-plan at
   `docs/rebuild/plans/self-upgrade-bb-feat-bugfix.builder-plan.md`
...
plan: docs/rebuild/plans/self-upgrade-bb-feat-bugfix.md
...
- `docs/odd-in-pos.md`
- `docs/rebuild/VALUE_PROPOSITION.md` (AC.PO.1 + AC.PO.2)
- `docs/rebuild/STATE.md`, `docs/rebuild/FUTURE_IDEAS.md`
- `docs/rebuild/spec/pos-v2-objectives-spec.md` (line 81 — v1.0
  self-upgrade objective)
- `docs/rebuild/plans/self-upgrade-clause-h-llm-merge.md` (#54
  plan; AC.H.5 + AC.H.8 text + §2 audit-path text)
- `docs/rebuild/plans/self-upgrade-clause-h-llm-merge.manifest.yaml`
  (#54 manifest pattern)
- `docs/rebuild/plans/research/bb-feat-synthetic-validation-plan.md`
