...
`docs/plans/memory-into-context-integration.md` §4b.
...
- `docs/plans/amendment-47-workspace-local-mcp-json-writer.manifest.yaml`
...
5. `pos-amend seal --plan-doc
   /Users/lukeivers/ivers-corp-pos-v2/docs/plans/amendment-47-workspace-local-mcp-json-writer.builder-plan.md
