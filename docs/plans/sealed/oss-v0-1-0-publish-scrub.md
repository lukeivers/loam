...
**Programme master:** `docs/plans/oss-v0-1-0-publish.md` (§5 M9 row + §6 sequencing rule #7 + §13 D-Q.OSS.6 ruling).
...
- Master plan: `docs/plans/oss-v0-1-0-publish.md` §5 M9 row + §13 D-Q.OSS.6.
...
- M2 sub-plan (predecessor): `docs/plans/oss-v0-1-0-publish-partition.md`.
- M6a/M6b.0/M6b.1/M6c sub-plans: `docs/plans/oss-v0-1-0-publish-dev-sdlc-plugin{,-m6b0,-m6b1,-m6c}.md`.
