...
- A1 plan: `docs/rebuild/plans/structural-enforcement-a1-substrate.md` (sealed; commits in §14).
...
- **Universal-paths admissions.** `docs/rebuild/plans/<plan>.md`, `CLAUDE.md`, `docs/odd-methodology.md`, `docs/rebuild/FUTURE_IDEAS.md`, `.gitignore` — all are dev-discipline edits backing the binding; A2 admits them via the carve-out list (Q6) regardless of the sentinel.
...
| D6 | Carve-out path list (D1 dev-discipline) | `docs/`, `tools/`, `CLAUDE*.md`, `.scratch/`, `personas/`, plus `.gitignore` and the universal-paths admissions (`docs/odd-methodology.md`, `docs/odd-in-pos.md`, `docs/rebuild/FUTURE_IDEAS.md`, etc.) (§1.2 + §6.4) | Open for owner ruling — recommendation matches programme D1 |
...
- A1 plan (locked, sealed): `docs/rebuild/plans/structural-enforcement-a1-substrate.md`
...
- Sibling plan-doc shape: `docs/rebuild/plans/structural-enforcement-a1-substrate.md` (the immediate precedent for A2's plan structure)
...
*End of research artefact. Plan-doc at `docs/rebuild/plans/structural-enforcement-a2-objective-binding-gate.md` consumes these findings.*
