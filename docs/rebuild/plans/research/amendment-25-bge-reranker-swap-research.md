...
`docs/rebuild/plans/amendment-25-bge-reranker-swap.md`.
...
`docs/rebuild/components/memory-system/proposal.md` carries the
...
- `docs/rebuild/components/memory-system/` — proposal doc note.
