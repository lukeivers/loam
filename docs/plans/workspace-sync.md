...
builder finalises at `docs/plans/workspace-sync.manifest.yaml`),
...
**Companions:** - **GG adversarial code review** (governs salvage decisions):
  `docs/plans/research/bb-cycle-architecture-b-retarget-review.md`
...
- **FF architecture conventions research** (governs
  architecture choice): `docs/plans/research/upgrade-architecture-conventions-research.md`
...
- **AA original sync research:** `docs/plans/research/canonical-to-workspace-sync-research.md`
  — D-1 through D-7 sync decisions. D-2 through D-7 carry
  over LOCKED into this plan.
- **BB-feat plan (the carryover source):**
  `docs/plans/self-upgrade-clause-h-llm-merge.md`
...
- `docs/plans/research/canonical-to-workspace-sync-research.md` (AA — original sync mechanism design, D-1 through D-7)
- `docs/plans/research/upgrade-architecture-conventions-research.md` (FF — A vs B architecture choice; locks B for framework code, A for the `pos` binary only)
- `docs/plans/research/bb-cycle-architecture-b-retarget-review.md` (GG — per-file salvage verdicts; ~70% of BB-cycle code carries over)
...
4. **Plan-before-code.** This plan exists; the builder
   ...
   `docs/plans/workspace-sync.builder-plan.md`
...
baseline: <HEAD~1 SHA>
plan: docs/plans/workspace-sync.md
...
4. **Required source-edit outside `workspace-sync/`.** Halt
   ...
   (`docs/plans/`, top-level docs) are exempt.
...
Full detail in `docs/plans/workspace-sync.builder-plan.md`
...
1. **No edits to `self-upgrade/`** — confirmed by AC.WS.S seal-diff
   ...
   `workspace-sync/` + `docs/plans/` + universal-paths
...
- `docs/plans/research/upgrade-architecture-conventions-research.md`
