...
2. **Scope fence.** Edits limited to:
   ...
   - `docs/rebuild/plans/v0-2-5-1-corrective-leak-timeout-verify-orphan.{md,manifest.yaml}`
...
6. Author manifest at
   `docs/rebuild/plans/v0-2-5-1-corrective-leak-timeout-verify-orphan.manifest.yaml`.
...
plan: docs/rebuild/plans/v0-2-5-1-corrective-leak-timeout-verify-orphan.md
plan_doc_ref: docs/rebuild/plans/v0-2-5-1-corrective-leak-timeout-verify-orphan.md
ac_count: 5
...
- v0.2.5 corrective C6 plan-doc: `docs/rebuild/plans/v0-2-5-corrective-c6-fixture-pm-and-extraction-resolution.md`
