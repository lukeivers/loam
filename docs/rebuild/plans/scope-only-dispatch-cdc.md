...
Codify in `docs/rebuild/FUTURE_IDEAS.md` — as a peer Core Development
...
1. Append one `## Core Development Convention — scope-only dispatch to
   ...
   `/Users/lukeivers/ivers-corp-pos-v2/docs/rebuild/FUTURE_IDEAS.md`.
...
3. Land this plan file at
   `/Users/lukeivers/ivers-corp-pos-v2/docs/rebuild/plans/scope-only-dispatch-cdc.md`.
...
1. `/Users/lukeivers/ivers-corp-pos-v2/docs/rebuild/FUTURE_IDEAS.md`
