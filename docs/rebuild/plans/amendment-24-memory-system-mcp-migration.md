...
`docs/rebuild/plans/research/amendment-24-memory-system-mcp-migration-research.md`.
...
3. Manifest (next):
   `docs/rebuild/plans/amendment-24-memory-system-mcp-migration.manifest.yaml`
...
9. Update `docs/rebuild/components/memory-system/proposal.md` §
