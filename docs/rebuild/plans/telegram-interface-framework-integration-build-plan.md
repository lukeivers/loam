...
**Proposal:** `docs/rebuild/components/telegram-interface-framework-integration/proposal.md`.
...
3. `docs/rebuild/plans/telegram-interface-framework-integration-build-plan.md`
   — this file.
