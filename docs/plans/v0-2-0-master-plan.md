...
**Parent plan:** `docs/plans/eric-final-delivery-plan-2026-05-04.md` (§2 v0.2.0 row — AUTHORITATIVE).
**Companion research:**

- `docs/plans/layered-skill-story-research-2026-05-04.md` (§3 — auto-creation; §3.6 universal-tier).
- `docs/plans/v0-1-9-master-plan.md` (precedent for cycle-decomposition + dispatch-brief shape; sealed `b01d3eb`).
- `docs/plans/v0-1-8-master-plan.md` (extractor full mode at v0.1.8 Cycles 3+4 — incremental mode here is the increment).
...
Plan-author dispatch (plan-before-code). Output: `docs/plans/v0-2-0-cycle-1-continuous-codebase-watch.md` (sub-plan-doc) + `.manifest.yaml`.
...
Plan-author dispatch (plan-before-code). Output: `docs/plans/v0-2-0-cycle-2-persona-driven-skill-capture.md` + `.manifest.yaml`.
...
- **Master plan source authority:** `docs/plans/eric-final-delivery-plan-2026-05-04.md` §2 v0.2.0 + Decisions I / N / P / Q / R (SOFT at v0.2.0).
- **Layered-skills auto-creation reference:** `docs/plans/layered-skill-story-research-2026-05-04.md` §3 + §3.6 universal-tier.
- **v0.1.9 master plan precedent:** `docs/plans/v0-1-9-master-plan.md` (sealed `b01d3eb`).
