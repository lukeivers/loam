...
| **3** | **intake** (LLM conversational capture → work item + verify-and-place) | Natural-language work capture; provenance; the verify-before-build confirm. | Increment 2 (a model to intake INTO); task #56 LLM seam | MED | future |
