...
Beyond subagents and teammates, in sessions where cross-session messaging is enabled, the same tool can message your other Claude Code sessions , on this machine or beyond it .
