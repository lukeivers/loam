...
**Ladders to:** AC.OSS.4 → AC.OSS.6 (final scrub) → AC.PO.1 + AC.PO.2 (prime objective per `docs/VALUE_PROPOSITION.md`).
...
- M7-partition-fix plan-doc (precedent shape): `docs/plans/oss-v0-1-0-publish-public-docs-partition-fix.md`.
...
- M-FBM precedent (same file rebaselined for primary-persona/__init__.py + session_start_emitter.py): `docs/plans/oss-v0-1-0-publish-memory-pivot.md` + commit `5db5db4`.
...
- Programme master plan: `docs/plans/oss-v0-1-0-publish.md` §5 row M8.
