...
**Companion plan:** `docs/plans/workspace-sync-alpha-hotfix-2.md` (§1-§5 + AC.α-hotfix-2.1–.4 + AC.α-hotfix-2.S).
...
Plan-doc: docs/plans/workspace-sync-alpha-hotfix-2.md
Builder-plan: docs/plans/workspace-sync-alpha-hotfix-2.builder-plan.md
Manifest: docs/plans/workspace-sync-alpha-hotfix-2.manifest.yaml
```
