...
**Plan (governs):** `docs/plans/self-upgrade-seal-bookkeeping-retrofit.md`.
**Manifest:** `docs/plans/self-upgrade-seal-bookkeeping-retrofit.manifest.yaml`.
...
allowed_prefixes = (
    ...
    "data/",
    "docs/plans/",
    "docs/archive/component-research/self-upgrade/",
)
```
...
The `pos-amend apply` step adds `docs/plans/` to prefixes
...
- Previous-BB clause-h artefacts (`docs/plans/self-
...
6. `pos-amend apply --dry-run docs/plans/self-upgrade-seal-bookkeeping-retrofit.manifest.yaml`
   — expect green; allowed_prefixes already include
   `docs/plans/` so the universal admission is a no-op.
...
9. `pos-amend seal --plan-doc docs/plans/self-upgrade-seal-bookkeeping-retrofit.md docs/plans/self-upgrade-seal-bookkeeping-retrofit.manifest.yaml`
