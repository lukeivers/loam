...
**Sources consulted:** `CLAUDE.md`, `docs/odd-in-pos.md`, `docs/FUTURE_IDEAS.md`, `docs/VALUE_PROPOSITION.md`, `docs/spec/pos-v2-objectives-spec.md`, `docs/STATE.md`, `README.md`, `.scratch/claude-output/pos-v2-rename-brainstorm.md`, `.scratch/claude-output/loam-rename-migration-plan.md`, component.md files for primary-persona-loader, memory-system, scope-of-work.
...
Inventory of sealed components from `docs/STATE.md` plus what's still in motion:
...
- Amendment-seal validation: a workflow that runs the seal-diff check on PRs touching `docs/plans/<amendment>.yaml` files.
...
- **Plan-before-code discipline.** Plans live at `docs/plans/<name>.md` (to migrate to `docs/plans/` post-launch for clarity). PRs without a plan doc get nudged back.
