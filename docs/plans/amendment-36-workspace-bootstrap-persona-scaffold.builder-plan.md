...
- `docs/plans/amendment-36-workspace-bootstrap-persona-scaffold.manifest.yaml` — author following #35's pattern. BASELINE = HEAD~1 of the amendment commit.
- `docs/plans/amendment-36-workspace-bootstrap-persona-scaffold.md` — append §14 method-decision record.
