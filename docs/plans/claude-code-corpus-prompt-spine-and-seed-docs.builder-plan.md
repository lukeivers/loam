...
**Manifest:** `docs/plans/claude-code-corpus-prompt-spine-and-seed-docs.manifest.yaml`.
**Locked research:** `docs/plans/research/persona-capability-knowledge-grounding-research.md`.
...
3. Land authoring guide → `docs/capability-corpus/AUTHORING.md` (AC.α.2).
