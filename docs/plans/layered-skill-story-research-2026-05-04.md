...
**Anchor sources cited inline:** `docs/VALUE_PROPOSITION.md`; `docs/STATE.md`; `docs/plans/v0-1-x-roadmap.md`; `docs/plans/value-prop-vs-actual-shape-audit-2026-05-04.md`; `docs/plans/eric-saas-app-use-case-version-sequence-2026-05-04.md`; `docs/FUTURE_IDEAS_DRAFT.md`; `plugins/loam-skills/skills/`; `plugins/dev-sdlc/skills/start-project.md`; `plugins/dev-sdlc/dev-mode-manifest.yaml`; `plugins/dev-sdlc/docs/conventions/fidraft-pattern.md`; `CLAUDE.md` (top-level loam Lens 1–5); Anthropic SKILL.md schema at https://code.claude.com/docs/en/skills (fetched 2026-05-04).
...
1. **`plan-before-code-author`** (dev-sdlc) — Before writing any source code for a build, author a plan-doc at `docs/plans/<name>.md` naming objective, scope, ACs, fence, named decisions. Source: `cdcs/plan-before-code.md`.
...
- **`docs/VALUE_PROPOSITION.md:60,66`** — the two prime-objective tests; Lens 2 anchor.
- **`CLAUDE.md` (top-level)** — Lens 1–5 always-on.
- **`docs/STATE.md`** — sealed-component history; v0.1.0 ship status.
- **`docs/plans/v0-1-x-roadmap.md`** — current 5-release roadmap; v0.1.5 horizon.
- **`docs/plans/value-prop-vs-actual-shape-audit-2026-05-04.md`** — persona-as-translator framing; coordination-token-spend tension.
- **`docs/plans/eric-saas-app-use-case-version-sequence-2026-05-04.md`** — companion plan; reconciliation captured in §7.4 + Decision J.
- **`docs/FUTURE_IDEAS_DRAFT.md`** — persona-behavior SKILL bundle (line 23), V11.C heavy entry (line 29), per-project PM (line 25), vertical-swarming, channel-violation-hook (line 125).
...
- **`docs/plans/v0-1-3-skill-packages.md`** — the v0.1.3 SKILL bundle plan-doc; provides shape-precedent.
