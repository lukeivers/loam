...
**Parent plan:** `docs/rebuild/plans/v0-2-1-master-plan.md` §3 Cycle 2 + §4 Cycle 2 dispatch brief.
...
Source pointers (READ FIRST):
  - sub-plan-doc (THIS file's predecessor) at docs/rebuild/plans/v0-2-1-cycle-2-promotion-rubric.md
  - master plan §3 Cycle 2 + §4 Cycle 2 dispatch brief at docs/rebuild/plans/v0-2-1-master-plan.md
  - layered-skills §4 (lines 261-323) at docs/rebuild/plans/layered-skill-story-research-2026-05-04.md
  - Decisions L + G + Q at parent docs/rebuild/plans/eric-final-delivery-plan-2026-05-04.md §3
...
Cycle-2 method decisions at §7. Master-plan method decisions at master plan §9 (`docs/rebuild/plans/v0-2-1-master-plan.md`). Cycle 1 method decisions at `docs/rebuild/plans/v0-2-1-cycle-1-eric-onboarding-hardening.md` §7.
