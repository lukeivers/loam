...
**Parent plan:** `docs/plans/v0-1-7-personas-pm-layered-skills.md` (§3 Surface #7 + §5 AC.PPM.* + §6 Cycle 2).
...
- **Cycle 2 fence:** `framework/per-project-pm/` (NEW component) only, plus
  `docs/plans/` (universal admission for sub-plan + manifest), plus
...
1. **Plan-doc** lands: this file at `docs/plans/v0-1-7-cycle-2-per-project-pm.md`.
2. **Manifest** lands: `docs/plans/v0-1-7-cycle-2-per-project-pm.manifest.yaml`
...
- **Parent plan** `docs/plans/v0-1-7-personas-pm-layered-skills.md` (committed
